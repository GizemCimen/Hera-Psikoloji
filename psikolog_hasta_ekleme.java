...
public class psikolog_hasta_ekleme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psikolog_hasta_ekleme);

        VeriTabani vt = new VeriTabani(psikolog_hasta_ekleme.this);
